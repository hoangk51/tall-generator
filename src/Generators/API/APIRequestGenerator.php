...
namespace Hoangk51\Generator\Generators\API;
...
class APIRequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = get_template('api.request.create_request', 'livewire-generator');
    ...
    private function generateUpdateRequest()
    {
        ...
        $templateData = get_template('api.request.update_request', 'livewire-generator');
