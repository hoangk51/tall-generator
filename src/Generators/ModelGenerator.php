...
use Hoangk51\Generator\Common\GeneratorFieldRelation;
use Hoangk51\Generator\Utils\FileUtil;
use Hoangk51\Generator\Utils\TableFieldsGenerator;
...
class ModelGenerator extends BaseGenerator
{
    ...
    {
        $templateData = get_template('model.model', 'livewire-generator');
    ...
    private function fillDocs($templateData)
    {
        ...
        $docsTemplate = get_template('docs.model', 'livewire-generator');
